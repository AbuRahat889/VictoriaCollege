...
export default function Button({ children, className, ...props }: ButtonProps) {
  return (
    <button
      className={clsx(
        "inline-flex w-full items-center justify-between gap-4 border border-borderColor bg-[#051251] p-4 text-primaryText transition-colors hover:bg-[#010f54] disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    >
